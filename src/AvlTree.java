public class AvlTree {
    ...
    private static long height( AvlNode t ) {
    ...
    private long getFactor (AvlNode t) {
    ...
    private AvlNode insert (long x, AvlNode t) {
        if( t == null )
    ...
    public AvlNode search(long el) {
        return search(root,el);
    }
    
    protected AvlNode search(AvlNode p, long el) {
        while (p != null) {
    ...
    public AvlNode remove(long el) {
        return remove(root,el);
    }
    
    protected AvlNode remove(AvlNode p, long el) {
        while (p != null) {
            /* se valor procuradp == chave do nó retorna referência ao nó */
            if (el==p.key){
                /* se valor procurado < chave do nó, procurar na sub-árvore esquerda deste nó */
    ...
    protected AvlNode searchFather (long el) {
        AvlNode p = root;
        AvlNode prev = null;
